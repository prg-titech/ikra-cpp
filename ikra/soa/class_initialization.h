...
\
  static void DBG_print_offsets() { /* Nothing to do. */ } \
}; \
\
...
\
  static void DBG_print_offsets() { \
    ...
    OffsetCounter<1>::DBG_print_offsets(); \
  } \
}; \
\
...
\
/* Alias for simplier access of object size. */ \
...
/* Debug function printing offsets. */ \
static void DBG_print_offsets() { \
  OffsetCounter<0>::DBG_print_offsets(); \
}
